...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_TransitionRoot, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_HDialog, mergeProps({ class: _ctx.wrapperClass }, _ctx.attrs, {
        ...
        return [
          createVNode(_component_HDialog, mergeProps({ class: _ctx.wrapperClass }, _ctx.attrs, {
            onClose: (e) => !_ctx.preventClose && _ctx.close(e)
          }), {
            default: withCtx(() => [
              _ctx.overlay ? (openBlock(), createBlock(_component_TransitionChild, mergeProps({
...
//# sourceMappingURL=Modal-4006228b.mjs.map
